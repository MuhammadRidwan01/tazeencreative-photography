    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500">Edit: {{ $portfolio->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <div class="mt-4">
                ...
                <p class="mt-2 text-sm text-gray-600">Update your portfolio item details</p>
            </div>
        </div>
            ...
            <div class="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex items-start space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">{{ $portfolio->category->name }}</p>
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <form method="POST" action="{{ route('admin.portfolios.update', $portfolio) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="px-6 py-6 bg-gray-50 border-b border-gray-200">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update information about your portfolio item</p>
                </div>
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                  placeholder="Describe this portfolio item...">{{ old('description', $portfolio->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
