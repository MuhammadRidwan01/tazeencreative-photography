...
<section class="section-padding">
    <div class="container-custom">
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12">
            <button data-filter="all" class="filter-btn bg-black text-white px-6 py-2 rounded-full font-medium transition-all duration-300">
                All
            </button>
            @foreach($categories as $category)
                <button data-filter="{{ $category->slug }}" class="filter-btn bg-gray-200 text-gray-700 hover:bg-gray-300 px-6 py-2 rounded-full font-medium transition-all duration-300">
                        ...
                        <div class="relative overflow-hidden rounded-lg shadow-lg card-hover bg-white">
                            ...
                            @if($portfolio->is_featured)
                                <div class="absolute top-4 left-4">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gold-500 text-black">
